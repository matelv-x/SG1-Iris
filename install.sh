...
CSS_HOOK = f"""{CSS_START}
    <link rel="stylesheet" href="css/iris.css?v=20260803-black-hole-force-open-start" />
    {CSS_END}"""

JS_HOOK = f"""{JS_START}
    <script type="module" src="js/iris.js?v=20260803-black-hole-force-open-start"></script>
    {JS_END}"""
